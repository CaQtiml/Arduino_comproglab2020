...
// set pin numbers:
#define D0 21  // USER LED Wake
#define ledPin  D0        // the number of the LED pin

const char* ssid     = "Test";
const char* password = "yakimplementtreappen";

#define APPID   "m5test4"
#define KEY     "x78DQAlUvOUD1EB"
#define SECRET  "F6itrtFjQxcZLBUaziMjfMYwa"
